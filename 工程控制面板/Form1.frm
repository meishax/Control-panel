...
Dim j As Integer
j = 0
Open App.Path & "\operating condition1show.txt" For Input As #9
    Do While Not EOF(9)
...
Dim j As Integer
j = 0
Open App.Path & "\operating condition1.txt" For Input As #2
    Do While Not EOF(2)
        ...
        Text3.Text = Mid(DEG_BACK_String, 11, L)
        ...
        Text5.Text = Mid(D_D_HIGH_String, 11, L)
